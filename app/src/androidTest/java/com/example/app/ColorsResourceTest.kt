...
class ColorsResourceTest {
    ...
    fun testNeonTealTransparentColorExists() {
        val colorResId = resources.getIdentifier("neon_teal_transparent", "color", context.packageName)
    ...
    fun testLightThemeColorsExist() {
        val lightColors = listOf(
            ...
            "light_error", "light_error_container", "light_on_error", "light_on_error_container",
    ...
    fun testDarkThemeColorsExist() {
        val darkColors = listOf(
            ...
            "dark_error", "dark_error_container", "dark_on_error", "dark_on_error_container",
    ...
    fun testColorComponentValues() {
        ...
        colorNames.forEach { colorName ->
            ...
            if (colorResId != 0) {
                ...
                assertTrue("Green component should be valid (0-255) for $colorName", green in 0..255)
    ...
    fun testLightPrimaryOnPrimaryContrast() {
        ...
        val onPrimaryResId = resources.getIdentifier("light_on_primary", "color", context.packageName)
        ...
        if (primaryResId != 0 && onPrimaryResId != 0) {
            ...
            assertTrue("Light theme on_primary should have adequate contrast with primary (>= 4.5:1)", 
                contrastRatio >= 4.5)
        }
    }
    ...
    fun testLightSecondaryOnSecondaryContrast() {
        val secondaryResId = resources.getIdentifier("light_secondary", "color", context.packageName)
        val onSecondaryResId = resources.getIdentifier("light_on_secondary", "color", context.packageName)
        ...
        if (secondaryResId != 0 && onSecondaryResId != 0) {
            ...
            assertTrue("Light theme on_secondary should have adequate contrast with secondary (>= 4.5:1)", 
                contrastRatio >= 4.5)
        }
    }
    ...
    fun testLightSurfaceOnSurfaceContrast() {
        ...
        val onSurfaceResId = resources.getIdentifier("light_on_surface", "color", context.packageName)
        ...
        if (surfaceResId != 0 && onSurfaceResId != 0) {
            ...
            assertTrue("Light theme on_surface should have adequate contrast with surface (>= 4.5:1)", 
                contrastRatio >= 4.5)
        }
    }
    ...
    fun testDarkPrimaryOnPrimaryContrast() {
        ...
        val onPrimaryResId = resources.getIdentifier("dark_on_primary", "color", context.packageName)
        ...
        if (primaryResId != 0 && onPrimaryResId != 0) {
            ...
            val contrastRatio = calculateContrastRatio(onPrimaryColor, primaryColor)
            assertTrue("Dark theme on_primary should have adequate contrast with primary (>= 4.5:1)", 
                contrastRatio >= 4.5)
        }
    }
    ...
    fun testErrorColorContrast() {
        ...
        val lightOnErrorResId = resources.getIdentifier("light_on_error", "color", context.packageName)
        ...
        if (lightErrorResId != 0 && lightOnErrorResId != 0) {
            ...
            assertTrue("Error color should have adequate contrast (>= 4.5:1)", 
                contrastRatio >= 4.5)
        }
    }
    ...
    fun testInvalidColorResourceHandling() {
        val invalidColorResId = resources.getIdentifier("non_existent_color", "color", context.packageName)
    ...
    fun testInvalidResourceTypeHandling() {
        ...
        if (invalidTypeResId != 0 && colorResId != 0) {
            assertNotEquals("Color resource should not be same as drawable resource", 
    ...
    fun testOnColorConsistency() {
        ...
        colorPairs.forEach { (baseColor, onColor) ->
            ...
            if (baseResId != 0 && onResId != 0) {
                ...
                assertNotEquals("On color $onColor should be different from base color $baseColor", 
    ...
    fun testAllDefinedColorsValid() {
        ...
        assertTrue("Should have most defined color resources valid", validColorCount >= allColors.size * 0.8)
    }
    ...
    fun testColorResourceAccessPerformance() {
        ...
        assertTrue("Color resource access should be performant (< 1000ms for 100 accesses)", 
            duration < 1000)
    }
    ...
    fun testMultipleColorResourcesPerformance() {
        ...
        assertTrue("Multiple color resource access should be performant (< 2000ms for 250 accesses)", 
            duration < 2000)
    }
    ...
    fun testColorResourcesExistInCurrentConfiguration() {
        ...
        coreColors.forEach { colorName ->
            val colorResId = resources.getIdentifier(colorName, "color", context.packageName)
            assertTrue("Core color $colorName should exist in current configuration", colorResId != 0)
    ...
    fun testMaterial3CompatibilityColors() {
        ...
        compatibilityColors.forEach { colorName ->
            ...
            if (colorResId != 0) {
                val color = ContextCompat.getColor(context, colorResId)
                assertNotEquals("Material 3 compatibility color $colorName should be valid", 0, color)
            }
        }
    }
