...
class AuraThemesTest {
    ...
    inner class AnimationStyleTests {
        ...
        fun `AnimationStyle enum should contain all expected values`() {
            ...
            assertEquals(expectedStyles, actualStyles, "AnimationStyle enum should contain all expected values")
            assertEquals(5, AuraTheme.AnimationStyle.values().size, "AnimationStyle enum should have exactly 5 values")
        }
    ...
    inner class CyberpunkThemeTests {
        ...
        inner class DarkColorSchemeTests {
            ...
            fun `CyberpunkTheme should maintain consistent primary colors between light and dark modes`() {
                ...
                assertEquals(CyberpunkTheme.lightColorScheme.secondary, CyberpunkTheme.darkColorScheme.secondary)
                assertEquals(CyberpunkTheme.lightColorScheme.tertiary, CyberpunkTheme.darkColorScheme.tertiary)
            }
        }
    }
    ...
    inner class ColorSchemeValidationTests {
        ...
        fun `All theme light color schemes should be valid ColorScheme objects`() {
            assertNotNull(CyberpunkTheme.lightColorScheme, "CyberpunkTheme light color scheme should not be null")
            assertNotNull(SolarFlareTheme.lightColorScheme, "SolarFlareTheme light color scheme should not be null")
            assertNotNull(ForestTheme.lightColorScheme, "ForestTheme light color scheme should not be null")
            
            assertTrue(CyberpunkTheme.lightColorScheme is ColorScheme, "CyberpunkTheme light color scheme should be ColorScheme")
            assertTrue(SolarFlareTheme.lightColorScheme is ColorScheme, "SolarFlareTheme light color scheme should be ColorScheme")
            assertTrue(ForestTheme.lightColorScheme is ColorScheme, "ForestTheme light color scheme should be ColorScheme")
        }
        ...
        fun `All theme dark color schemes should be valid ColorScheme objects`() {
            assertNotNull(CyberpunkTheme.darkColorScheme, "CyberpunkTheme dark color scheme should not be null")
            assertNotNull(SolarFlareTheme.darkColorScheme, "SolarFlareTheme dark color scheme should not be null")
            assertNotNull(ForestTheme.darkColorScheme, "ForestTheme dark color scheme should not be null")
            
            assertTrue(CyberpunkTheme.darkColorScheme is ColorScheme, "CyberpunkTheme dark color scheme should be ColorScheme")
            assertTrue(SolarFlareTheme.darkColorScheme is ColorScheme, "SolarFlareTheme dark color scheme should be ColorScheme")
            assertTrue(ForestTheme.darkColorScheme is ColorScheme, "ForestTheme dark color scheme should be ColorScheme")
        }
        ...
        fun `Color schemes should have different background colors for light and dark modes`() {
            assertNotEquals(CyberpunkTheme.lightColorScheme.background, CyberpunkTheme.darkColorScheme.background,
                "CyberpunkTheme should have different light/dark backgrounds")
            
            assertNotEquals(SolarFlareTheme.lightColorScheme.background, SolarFlareTheme.darkColorScheme.background,
                "SolarFlareTheme should have different light/dark backgrounds")
            
            assertNotEquals(ForestTheme.lightColorScheme.background, ForestTheme.darkColorScheme.background,
    ...
    inner class GetColorSchemeTests {
        ...
        fun `getColorScheme should return light scheme when isDarkTheme is false`() {
            composeTestRule.setContent {
                ...
                assertEquals(CyberpunkTheme.lightColorScheme, colorScheme, "Should return light color scheme")
            }
        }
        ...
        fun `getColorScheme should return dark scheme when isDarkTheme is true`() {
            composeTestRule.setContent {
                ...
                assertEquals(CyberpunkTheme.darkColorScheme, colorScheme, "Should return dark color scheme")
            }
        }
        ...
        fun `getColorScheme should work for all themes in light mode`() {
            composeTestRule.setContent {
                assertEquals(CyberpunkTheme.lightColorScheme, CyberpunkTheme.getColorScheme(isDarkTheme = false),
                    "CyberpunkTheme should return light scheme")
                
                assertEquals(SolarFlareTheme.lightColorScheme, SolarFlareTheme.getColorScheme(isDarkTheme = false),
                    "SolarFlareTheme should return light scheme")
                
                assertEquals(ForestTheme.lightColorScheme, ForestTheme.getColorScheme(isDarkTheme = false),
        ...
        fun `getColorScheme should work for all themes in dark mode`() {
            composeTestRule.setContent {
                assertEquals(CyberpunkTheme.darkColorScheme, CyberpunkTheme.getColorScheme(isDarkTheme = true),
                    "CyberpunkTheme should return dark scheme")
                
                assertEquals(SolarFlareTheme.darkColorScheme, SolarFlareTheme.getColorScheme(isDarkTheme = true),
                    "SolarFlareTheme should return dark scheme")
                
                assertEquals(ForestTheme.darkColorScheme, ForestTheme.getColorScheme(isDarkTheme = true),
    ...
    inner class EdgeCaseTests {
        ...
        fun `Theme descriptions should not be empty or blank`() {
            assertFalse(CyberpunkTheme.description.isEmpty(), "CyberpunkTheme description should not be empty")
            assertFalse(CyberpunkTheme.description.isBlank(), "CyberpunkTheme description should not be blank")
            
            assertFalse(SolarFlareTheme.description.isEmpty(), "SolarFlareTheme description should not be empty")
            assertFalse(SolarFlareTheme.description.isBlank(), "SolarFlareTheme description should not be blank")
            
            assertFalse(ForestTheme.description.isEmpty(), "ForestTheme description should not be empty")
            assertFalse(ForestTheme.description.isBlank(), "ForestTheme description should not be blank")
        }

        @Test
        @DisplayName("Accent colors should have full alpha channel")
        fun `Accent colors should have full alpha channel`() {
            assertEquals(0xFF, (CyberpunkTheme.accentColor.value shr 24).toInt(),
                "CyberpunkTheme accent color should have full alpha")
            assertEquals(0xFF, (SolarFlareTheme.accentColor.value shr 24).toInt(),
                "SolarFlareTheme accent color should have full alpha")
            assertEquals(0xFF, (ForestTheme.accentColor.value shr 24).toInt(),
        ...
        fun `Color contrast should be appropriate - on colors should differ from base colors`() {
            assertNotEquals(CyberpunkTheme.lightColorScheme.primary, CyberpunkTheme.lightColorScheme.onPrimary,
                "CyberpunkTheme primary and onPrimary should be different")
            
            assertNotEquals(SolarFlareTheme.lightColorScheme.primary, SolarFlareTheme.lightColorScheme.onPrimary,
                "SolarFlareTheme primary and onPrimary should be different")
            
            assertNotEquals(ForestTheme.lightColorScheme.primary, ForestTheme.lightColorScheme.onPrimary,
        ...
        fun `All themes should have meaningful names reflecting their character`() {
            assertTrue(CyberpunkTheme.name.contains("Cyberpunk"), "CyberpunkTheme name should be relevant")
            assertTrue(SolarFlareTheme.name.contains("Solar"), "SolarFlareTheme name should be relevant")
